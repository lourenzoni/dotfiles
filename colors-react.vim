...
let s:spaceGray5 = {'gui': '#B7CBF4', 'cterm256': '240'}
" let s:spaceSteel = {'gui': '#DEDEDE', 'cterm256': '253'}
let s:spaceSteel = {'gui': '#DEDEDE', 'cterm256': '251'}
let s:spaceSteel2 = {'gui': '#DEDEDE', 'cterm256': '248'}
let s:spaceSteel3 = {'gui': '#DEDEDE', 'cterm256': '8'}
let s:spaceSteel4 = {'gui': '#DEDEDE', 'cterm256': '11'}
let s:spaceSteel5 = {'gui': '#DEDEDE', 'cterm256': '235'}
let s:spaceWhite = {'gui': '#F8F8F8', 'cterm256': '231'}
" let s:spaceViolet = {'gui': '#CF73E6', 'cterm256': '170'}
let s:spaceViolet = {'gui': '#CF73E6', 'cterm256': '147'}
" let s:spaceViolet = {'gui': '#CF73E6', 'cterm256': '176'}
let s:spaceBlue = {'gui': '#91AADF', 'cterm256': '110'}
"let s:spaceBlue = {'gui': '#91AADF', 'cterm256': '110'}
let s:spaceBlue2 = {'gui': '#B7CBF4', 'cterm256': '111'}
let s:spaceBlue3 = {'gui': '#B7CBF4', 'cterm256': '32'}
let s:spaceBlue4 = {'gui': '#F0D50C', 'cterm256': '75'}
let s:spaceGreen = {'gui': '#57BA37', 'cterm256': '72'}
let s:spaceGreen2 = {'gui': '#57BA37', 'cterm256': '74'}
let s:spaceGreen3 = {'gui': '#57BA37', 'cterm256': '77'}
let s:spaceGreen4 = {'gui': '#57BA37', 'cterm256': '78'}
let s:spaceGreen5 = {'gui': '#57BA37', 'cterm256': '79'}
let s:spaceGreen6 = {'gui': '#57BA37', 'cterm256': '70'}
"let s:spaceGreen = {'gui': '#57BA37', 'cterm256': '71'}
let s:spaceGoo = {'gui': '#D8FA3B', 'cterm256': '191'}
let s:spaceGoo2 = {'gui': '#D8FA3B', 'cterm256': '192'}
let s:spaceGoo3 = {'gui': '#D8FA3B', 'cterm256': '195'}
"let s:spaceGold = {'gui': '#F0D50C', 'cterm256': '220'}
let s:spaceGold3 = {'gui': '#F0D50C', 'cterm256': '33'}
let s:spaceGold2 = {'gui': '#F0D50C', 'cterm256': '58'}
let s:spaceOrange = {'gui': '#F66100', 'cterm256': '202'}
let s:spaceOrange2 = {'gui': '#F66100', 'cterm256': '167'}
let s:spaceRed = {'gui': '#821A1A', 'cterm256': '1'}
let s:spaceRed2 = {'gui': '#FF0000', 'cterm256': '196'}
let s:spaceRed3 = {'gui': '#FF0000', 'cterm256': '160'}
let s:spaceRed4 = {'gui': '#FF0000', 'cterm256': '52'}
...
" Editor
call <sid>hi('ColorColumn', s:none, s:spaceSteel4, 'none')
call <sid>hi('Cursor', s:spaceBlack, s:spaceSteel, 'none')
call <sid>hi('CursorColumn', s:none, s:spaceSteel4, 'none')
call <sid>hi('CursorLine', s:none, s:spaceSteel4, 'none')
call <sid>hi('CursorLineNr', s:spaceSteel, s:spaceSteel4, 'none')
call <sid>hi('Directory', s:spaceBlue, s:spaceBlack, 'none')
"call <sid>hi('Folded', s:spaceGray3, s:none, 'none')
"call <sid>hi('Folded', s:spaceBlack, s:spaceGray5, 'none')
call <sid>hi('Folded', s:spaceGray2, s:spaceSteel5, 'none')
"call <sid>hi('IncSearch', s:spaceBlack, s:spaceBlue2, 'none')
"call <sid>hi('Search', s:spaceBlack, s:spaceBlue, 'none')
call <sid>hi('IncSearch', s:spaceBlack, s:spaceOrange, 'none')
call <sid>hi('Search', s:spaceBlue2, s:spaceGray1, 'none')
call <sid>hi('LineNr', s:spaceGray3, s:spaceBlack2, 'none')
call <sid>hi('MatchParen', s:spaceGreen, s:spaceGray2, 'none')
call <sid>hi('Normal', s:spaceWhite, s:spaceBlack, 'none')
call <sid>hi('Pmenu', s:spaceBlack, s:spaceGray3, 'none')
call <sid>hi('PmenuSel', s:spaceBlack, s:spaceBlue, 'none')
call <sid>hi('StatusLine', s:spaceBlack, s:spaceGray4, 'none')
call <sid>hi('StatusLineNC', s:spaceBlack, s:spaceSteel4, 'none')
call <sid>hi('VertSplit', s:spaceSteel4, s:spaceSteel4, 'none')
...
call <sid>hi('Identifier', s:spaceBlue4, s:none, 'none')
call <sid>hi('Keyword', s:spaceBlue4, s:none, 'none')
...
call <sid>hi('SpellBad', s:spaceRed4, s:spaceSteel4, 'italic,undercurl')
call <sid>hi('SpellCap', s:spaceGold2, s:none, 'italic,undercurl')
call <sid>hi('SpellLocal', s:spaceOrange, s:none, 'undercurl')
call <sid>hi('Statement', s:spaceViolet, s:none, 'none')
call <sid>hi('StorageClass', s:spaceBlue4, s:none, 'none')
call <sid>hi('String', s:spaceGreen, s:none, 'none')
call <sid>hi('Tag', s:spaceBlue4, s:none, 'none')
...
" Diff Mode
if &diff
  call <sid>hi('DiffAdd', s:spaceGreen6, s:spaceSteel3, 'none')
  call <sid>hi('DiffChange', s:spaceGray3, s:spaceSteel3, 'none')
  call <sid>hi('DiffDelete', s:spaceRed3, s:spaceSteel3, 'none')
  call <sid>hi('DiffText', s:spaceBlue4, s:spaceSteel3, 'none')
else
  call <sid>hi('DiffAdd', s:spaceGreen, s:none, 'none')
  call <sid>hi('DiffChange', s:spaceBlue4, s:none, 'none')
...
call <sid>hi('cssBraces', s:spaceGreen2, s:none, 'none')
...
call <sid>hi('cssPseudoClass', s:spaceBlue4, s:none, 'none')
call <sid>hi('cssPseudoClassId', s:spaceBlue4, s:none, 'none')
call <sid>hi('cssPseudoClassLang', s:spaceBlue4, s:none, 'none')
call <sid>hi('cssSelectorOperator', s:spaceSteel, s:none, 'none')
call <sid>hi('cssTagName', s:spaceBlue2, s:none, 'none')
call <sid>hi('cssURL', s:spaceBlue4, s:none, 'none')
...
call <sid>hi('javaScriptFunction', s:spaceBlue4, s:none, 'none')
call <sid>hi('javaScriptIdentifier', s:spaceBlue, s:none, 'none')
call <sid>hi('javaScriptMember', s:spaceOrange2, s:none, 'none')
call <sid>hi('javaScriptNull', s:spaceGoo, s:none, 'none')
call <sid>hi('javaScriptNumber', s:spaceGoo2, s:none, 'none')
call <sid>hi('javaScriptParens', s:spaceGreen3, s:none, 'none')
call <sid>hi('javaScriptSpecial', s:spaceGoo3, s:none, 'none')
call <sid>hi('javaScriptStringS', s:spaceGreen, s:none, 'none')
call <sid>hi('javascriptArrayMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptArrayStaticMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptArrowFunc', s:spaceBlue4, s:none, 'none')
call <sid>hi('javascriptAsyncFuncKeyword', s:spaceGold3, s:none, 'none')
call <sid>hi('javascriptAwaitFuncKeyword', s:spaceGold3, s:none, 'none')
call <sid>hi('javascriptBraces', s:spaceGreen4, s:none, 'none')
call <sid>hi('javascriptBrackets', s:spaceGreen5, s:none, 'none')
call <sid>hi('javascriptCacheMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptClassExtends', s:spaceSteel, s:none, 'none')
call <sid>hi('javascriptClassKeyword', s:spaceGold3, s:none, 'none')
call <sid>hi('javascriptClassName', s:spaceBlue, s:none, 'none')
call <sid>hi('javascriptClassSuperName', s:spaceBlue, s:none, 'none')
call <sid>hi('javascriptDOMElemAttrs', s:spaceSteel2, s:none, 'none')
call <sid>hi('javascriptDOMEventMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptDOMNodeMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptDOMStorageMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptDateMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptDefault', s:spaceBlue4, s:none, 'none')
...
call <sid>hi('javascriptHeadersMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptIdentifierName', s:spaceBlue, s:none, 'none')
call <sid>hi('javascriptImport', s:spaceViolet, s:none, 'none')
call <sid>hi('javascriptLabel', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptLogicSymbols', s:spaceViolet, s:none, 'none')
call <sid>hi('javascriptMathStaticMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptObjectLabel', s:spaceSteel2, s:none, 'none')
call <sid>hi('javascriptOperator', s:spaceViolet, s:none, 'none')
call <sid>hi('javascriptPropertyName', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptStringMethod', s:spaceOrange2, s:none, 'none')
call <sid>hi('javascriptVariable', s:spaceWhite, s:none, 'none')
call <sid>hi('javascriptYield', s:spaceBlue4, s:none, 'none')
call <sid>hi('jsArrowFunction', s:spaceBlue4, s:none, 'none')
call <sid>hi('jsClassDefinition', s:spaceBlue, s:none, 'none')
call <sid>hi('jsClassKeyword', s:spaceBlue4, s:none, 'none')
call <sid>hi('jsDecorator', s:spaceGoo, s:none, 'none')
call <sid>hi('jsDestructuringBlock', s:spaceSteel2, s:none, 'none')
call <sid>hi('jsExportDefault', s:spaceGold3, s:none, 'none')
call <sid>hi('jsExtendsKeyword', s:spaceSteel2, s:none, 'none')
call <sid>hi('jsFuncArgs', s:spaceWhite, s:none, 'none')
call <sid>hi('jsFuncCall', s:spaceBlue, s:none, 'none')
call <sid>hi('jsFunction', s:spaceBlue4, s:none, 'none')
...
call <sid>hi('jsObjectBraces', s:spaceGreen2, s:none, 'none')
call <sid>hi('jsObjectKey', s:spaceSteel, s:none, 'none')
"call <sid>hi('jsObjectKey', s:spaceOrange, s:none, 'none')
...
call <sid>hi('jsTemplateBraces', s:spaceGreen2, s:none, 'none')
...
call <sid>hi('jsxAttributeBraces', s:spaceGreen2, s:none, 'none')
call <sid>hi('jsxCloseString', s:spaceBlue2, s:none, 'none')
call <sid>hi('jsxCloseTag', s:spaceOrange, s:none, 'none')
call <sid>hi('jsxString', s:spaceGreen, s:none, 'none')
call <sid>hi('jsxTag', s:spaceGold3, s:none, 'none')
call <sid>hi('jsxTagName', s:spaceOrange2, s:none, 'none')
...
call <sid>hi('yamlKey', s:spaceBlue4, s:none, 'none')


hi Noise ctermfg=77 ctermbg=NONE gui=NONE
